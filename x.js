...
//compressTo:UTF16
_compress_UTF16(s,15,function(n){return String.fromCharCode(n+32)});


//decompressFrom:UTF16-input
const s=t;
_decompress_UTF16(s.length,16384,function(n){return s.charCodeAt(n)-32});